package b.laixuantam.myaarlibrary.helper.RecyclerViewSnap;
...
public class GravityDelegate
{
    ...
    public GravityDelegate(int gravity, boolean enableSnapLast, GravitySnapHelper.SnapListener listener)
    {
    ...
    public void attachToRecyclerView(@NonNull RecyclerView recyclerView)
    {
        ...
        {
            isRtlHorizontal = recyclerView.getContext().getResources().getConfiguration().getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
        }
