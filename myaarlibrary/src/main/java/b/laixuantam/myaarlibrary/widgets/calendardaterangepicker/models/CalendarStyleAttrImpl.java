    ...
    private void setAttributes(@NonNull final Context context, @Nullable final AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            try {
                ...
                isSwipeable = ta.getBoolean(R.styleable.DateRangeMonthView_swipeable, true);
                isShowHeader = ta.getBoolean(R.styleable.DateRangeMonthView_show_header, true);
