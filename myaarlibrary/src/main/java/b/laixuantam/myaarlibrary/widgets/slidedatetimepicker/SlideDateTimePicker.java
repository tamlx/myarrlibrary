...
public class SlideDateTimePicker {
    ...
    public void setTypeShowDialog(int typeShowDialog) {
    ...
    public static class Builder {
        ...
        public Builder setTypeShowDialog(int type_show_dialog) {
            this.typeShowDialog = type_show_dialog;
            return this;
        }
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setTypeShowDialog(typeShowDialog);
...
@Override public void onDateTimeCancel() {
 ...
 .setTypeShowDialog(2)//0: both date and time - 1: date picker - 2: time picker
 .build()
 .show();
 }
 */
