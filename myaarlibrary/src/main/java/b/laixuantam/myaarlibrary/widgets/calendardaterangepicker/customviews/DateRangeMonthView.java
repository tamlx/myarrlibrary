...
import b.laixuantam.myaarlibrary.widgets.calendardaterangepicker.models.DayContainer;
...
class DateRangeMonthView extends LinearLayout {
    ...
    private void makeAsSelectedDate(@NonNull final DayContainer container,
        ...
        if (stripType == DateRangeCalendarManager.CalendarRangeType.START_DATE && maxDate != null &&
