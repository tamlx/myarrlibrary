...
import b.laixuantam.myaarlibrary.widgets.ACRA.log.ACRALog;
import b.laixuantam.myaarlibrary.widgets.ACRA.log.AndroidLogDelegate;
...
public class ACRA {
    ...
    public static boolean DEV_LOGGING = false; // Should be false for
    // release.
     ...
     * @throws IllegalStateException if {@link ACRA#init(Application)} has not yet
     *                               been called.
     */
