package b.laixuantam.myaarlibrary.widgets.custompicker;
 ...
 */
public class MyCustomPicker extends LinearLayout {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(MyCustomPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(MyCustomPicker view, @ScrollState int scrollState);
    }
     ...
     */
    public MyCustomPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mContext = context;
        mNumberFormatter = NumberFormat.getInstance();

        final TypedArray attributes = context.obtainStyledAttributes(attrs,
                R.styleable.MyCustomPicker, defStyle, 0);

        final Drawable selectionDivider = attributes.getDrawable(
                R.styleable.MyCustomPicker_cp_divider);
        if (selectionDivider != null) {
            ...
            mDividerColor = attributes.getColor(R.styleable.MyCustomPicker_cp_dividerColor,
                    mDividerColor);
        ...
        mDividerDistance = attributes.getDimensionPixelSize(
                R.styleable.MyCustomPicker_cp_dividerDistance, defDividerDistance);
        mDividerThickness = attributes.getDimensionPixelSize(
                R.styleable.MyCustomPicker_cp_dividerThickness, defDividerThickness);

        mOrder = attributes.getInt(R.styleable.MyCustomPicker_cp_order, ASCENDING);
        mOrientation = attributes.getInt(R.styleable.MyCustomPicker_cp_orientation, VERTICAL);

        mWidth = attributes.getDimensionPixelSize(R.styleable.MyCustomPicker_cp_width,
                SIZE_UNSPECIFIED);
        mHeight = attributes.getDimensionPixelSize(R.styleable.MyCustomPicker_cp_height,
                SIZE_UNSPECIFIED);
        ...
        mValue = attributes.getInt(R.styleable.MyCustomPicker_cp_value, mValue);
        mMaxValue = attributes.getInt(R.styleable.MyCustomPicker_cp_max, mMaxValue);
        mMinValue = attributes.getInt(R.styleable.MyCustomPicker_cp_min, mMinValue);

        mSelectedTextAlign = attributes.getInt(R.styleable.MyCustomPicker_cp_selectedTextAlign,
                mSelectedTextAlign);
        mSelectedTextColor = attributes.getColor(R.styleable.MyCustomPicker_cp_selectedTextColor,
                mSelectedTextColor);
        mSelectedTextSize = attributes.getDimension(R.styleable.MyCustomPicker_cp_selectedTextSize,
                spToPx(mSelectedTextSize));
        mSelectedTextStrikeThru = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_selectedTextStrikeThru, mSelectedTextStrikeThru);
        mSelectedTextUnderline = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_selectedTextUnderline, mSelectedTextUnderline);
        mSelectedTypeface = Typeface.create(attributes.getString(
                R.styleable.MyCustomPicker_cp_selectedTypeface), Typeface.NORMAL);
        mTextAlign = attributes.getInt(R.styleable.MyCustomPicker_cp_textAlign, mTextAlign);
        mTextColor = attributes.getColor(R.styleable.MyCustomPicker_cp_textColor, mTextColor);
        mTextSize = attributes.getDimension(R.styleable.MyCustomPicker_cp_textSize,
                spToPx(mTextSize));
        mTextStrikeThru = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_textStrikeThru, mTextStrikeThru);
        mTextUnderline = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_textUnderline, mTextUnderline);
        mTypeface = Typeface.create(attributes.getString(R.styleable.MyCustomPicker_cp_typeface),
                Typeface.NORMAL);
        mFormatter = stringToFormatter(attributes.getString(R.styleable.MyCustomPicker_cp_formatter));
        mFadingEdgeEnabled = attributes.getBoolean(R.styleable.MyCustomPicker_cp_fadingEdgeEnabled,
                mFadingEdgeEnabled);
        mFadingEdgeStrength = attributes.getFloat(R.styleable.MyCustomPicker_cp_fadingEdgeStrength,
                mFadingEdgeStrength);
        mScrollerEnabled = attributes.getBoolean(R.styleable.MyCustomPicker_cp_scrollerEnabled,
                mScrollerEnabled);
        mWheelItemCount = attributes.getInt(R.styleable.MyCustomPicker_cp_wheelItemCount,
                mWheelItemCount);
        mLineSpacingMultiplier = attributes.getFloat(
                R.styleable.MyCustomPicker_cp_lineSpacingMultiplier, mLineSpacingMultiplier);
        mMaxFlingVelocityCoefficient = attributes.getInt(
                R.styleable.MyCustomPicker_cp_maxFlingVelocityCoefficient,
                mMaxFlingVelocityCoefficient);
        mHideWheelUntilFocused = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_hideWheelUntilFocused, false);
        mAccessibilityDescriptionEnabled = attributes.getBoolean(
                R.styleable.MyCustomPicker_cp_accessibilityDescriptionEnabled, true);
        ...
        mWrapSelectorWheel = attributes.getBoolean(R.styleable.MyCustomPicker_cp_wrapSelectorWheel,
                mWrapSelectorWheel);
     ...
     * <p>
     * If the argument is less than the {@link MyCustomPicker#getMinValue()} and
     * {@link MyCustomPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link MyCustomPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link MyCustomPicker#getMinValue()} and
     * {@link MyCustomPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link MyCustomPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link MyCustomPicker#getMaxValue()} and
     * {@link MyCustomPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link MyCustomPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link MyCustomPicker#getMinValue()} and
     * {@link MyCustomPicker#getMaxValue()} values.
     * <p>
...
//        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyCustomPicker.class.getName());
...
@Override public void onScrollStateChange(NumberPicker picker, int scrollState) {
