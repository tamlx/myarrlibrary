...
public class KProgressHUD {
    ...
    public KProgressHUD setCustomView() {
        if (progressLayout == null) {
            ...
            MKLoader mkLoaderClassicSpinner = progressLayout.findViewById(R.id.mkLoaderClassicSpinner);
            MKLoader mkLoaderLineSpinner = progressLayout.findViewById(R.id.mkLoaderLineSpinner);
            MKLoader mkLoaderFishSpinner = progressLayout.findViewById(R.id.mkLoaderFishSpinner);

            ProgressBar mainProgress = progressLayout.findViewById(R.id.pb_main_progress);

            TextView tvProgressTitle = progressLayout.findViewById(R.id.tvLoadingTitle);
            ...
            LinearLayout ll_loading_bound = progressLayout.findViewById(R.id.ll_loading_bound);
        ...
        mProgressDialog.setView(progressLayout);
