...
/**
 * ScaleTouchListener.Config config = new ScaleTouchListener.Config(100,0.90f,0.5f);
 * ScaleTouchListener listener = new ScaleTouchListener(config) {
 *
 * @Override public void onClick(View v) {
 * Toast.makeText(MainActivity.this,"ClickView",Toast.LENGTH_SHORT).show();
 * }
 * };
