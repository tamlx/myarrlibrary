package b.laixuantam.myaarlibrary.widgets.cptr.recyclerview;
...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<ViewHolder> {
    ...
    public long getItemIdHF(int position) {
        if (typeAdapter == TypeAdapter.SUPERADAPTER) {
            return superAdapter.getItemId(position);
        }
    ...
    public final ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        if (type != TYPE_HEADER && type != TYPE_FOOTER) {
            ...
            if (typeAdapter == TypeAdapter.SUPERADAPTER) {
                SuperViewHolder superViewHolder = superAdapter.onCreateViewHolder(viewGroup, type);
    ...
    public final void onBindViewHolder(final ViewHolder vh, int position) {
        ...
        if (isHeader(position)) {
            ...
            if (typeAdapter == TypeAdapter.SUPERADAPTER) {
                superAdapter.onBindViewHolder((SuperViewHolder) vh, getRealPosition(position));
                return;
            }
    ...
    public int getItemCountHF() {
        ...
        if (typeAdapter == TypeAdapter.SUPERADAPTER) {
            return superAdapter.getItemCount();
    ...
    public int getItemViewTypeHF(int position) {
        ...
        if (typeAdapter == TypeAdapter.SUPERADAPTER) {
            return superAdapter.getItemViewType(position);
        }
    ...
    public RecyclerAdapterWithHF(RecyclerView.Adapter<ViewHolder> adapter) {
        ...
        typeAdapter = TypeAdapter.DEFAULT;
    ...
    public RecyclerAdapterWithHF(SuperAdapter superAdapter) {
        super();
        this.superAdapter = superAdapter;
        superAdapter.registerAdapterDataObserver(adapterDataObserver);
        typeAdapter = TypeAdapter.SUPERADAPTER;
