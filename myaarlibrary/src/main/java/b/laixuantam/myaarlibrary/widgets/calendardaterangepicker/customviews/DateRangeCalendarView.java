...
import b.laixuantam.myaarlibrary.widgets.calendardaterangepicker.models.CalendarStyleAttrImpl;
...
public class DateRangeCalendarView extends LinearLayout implements DateRangeCalendarViewApi {
    ...
    private CustomSwipeableViewPager vpCalendar;
    private CalendarStyleAttributes calendarStyleAttr;
    private CalendarListener mCalendarListener;
    private View layout_calendar_header;

    private final static int TOTAL_ALLOWED_MONTHS = 120;//10 year
    ...
    private void initViews(final Context context, final AttributeSet attrs) {
        ...
        layout_calendar_header = findViewById(R.id.layout_calendar_header);
        vpCalendar = findViewById(R.id.vpCalendar);

        if (calendarStyleAttr.isShowHeader()) {
...
//            rlHeaderCalendar.setBackground(calendarStyleAttr.getHeaderBg());
        ...
        if (calendarStyleAttr.isSwipeable()) {
        ...
        vpCalendar.setPagingEnabled(calendarStyleAttr.isSwipeable());
