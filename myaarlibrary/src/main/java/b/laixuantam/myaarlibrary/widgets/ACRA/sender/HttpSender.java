...
import b.laixuantam.myaarlibrary.widgets.ACRA.ACRAConfiguration;
...
import b.laixuantam.myaarlibrary.widgets.ACRA.util.HttpRequest;
import b.laixuantam.myaarlibrary.widgets.ACRA.util.JSONReportBuilder;
        ...
        try {
            ...
            if (ACRA.DEV_LOGGING)
                ACRA.log.d(ACRA.LOG_TAG,
                        "ReqeustHeades : " + ACRA.getConfig().getHttpHeaders());
