...
public class CircularImageView extends ImageView {
	...
	public CircularImageView(Context context) {
		this(context, null, R.styleable.CustomCircularImageViewTheme_circularImageViewStyle);
	}

	public CircularImageView(Context context, AttributeSet attrs) {
		this(context, attrs, R.styleable.CustomCircularImageViewTheme_circularImageViewStyle);
	}
	...
	public void onDraw(Canvas canvas) {
		// Don't draw anything without an linkImage
		if(image == null)
			return;
		...
		// Draw the circular linkImage itself
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		// Redraw linkImage and return super type
		this.invalidate();
